...
function ColourMode() {
	const [colorModeState, setColorModeState] = useState('dark');
	...
	const handleClick = () => {
		currentMode = localStorage.getItem('colorMode');
	...
	return (
		<button onClick={handleClick} aria-label={`Switch to ${colorModeState === 'light' ? 'dark' : 'light'} mode`} className={styles.dm_switcher}>
