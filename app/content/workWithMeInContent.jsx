...
export const ContentSection1 = {
	...
	bodyContent: () => {
		return (
			<>
				<p>
					I have around 15 years experience working on the web. I&apos;m a
					generalist who nerds out on everything from web typography to
					accessibility, to the subtle art of making things <strong>POP</strong>
					.
				</p>
				...
				<ul>
					<ListItem
						content={
							'Improve the <strong>look and feel</strong> of your website'
						}
					/>
					<ListItem
						content={
							'Audit your website or web app for optimal <strong>accessibility</strong> to the latest WCAG guidelines'
						}
					/>
					<ListItem
						content={'<strong>Make the necessary fixes</strong> for compliance'}
					/>
					<ListItem content={'Bump up your google Lighthouse score'} />
					<ListItem
						content={'Design and build <strong>new features</strong>'}
					/>
					<ListItem
						content={'Optimise your pages for <strong>search engines</strong>'}
					/>
				</ul>

				<p>
					<span className="text-intro">
						There&apos;s that annoying broken piece of UI on your website or web
						app and the developer you used has ghosted you.
					</span>
				</p>

				<p>
					I can step in at any time during the website or app development cycle.
					Wireframe, mockup, iterate in Figma, build new features, address
					issues.
				</p>

				<p>
					I&apos;m also close to content designers and SEO specialists who
					I&apos;ve worked with before. We can team up to ensure your website
					content is the best it can be.
				</p>
			</>
		)
	},
		...
		return (
			<>
				<p>
					...
					payment, especially for cross-border payments. Why?
				</p>
				<ul>
					<ListItem
						content={
							'<strong>24 hour 7 days a week</strong> settlement within 30 mins. No waiting for bank transfers'
						}
					/>
					<ListItem
						content={'<strong>Verifiable</strong> on the blockchain.'}
					/>
					<ListItem
						content={
							'Backed by <strong>proof-of-work</strong> rather than money printed out of nowhere. True value for value'
						}
					/>
				</ul>
				<p>Invoices will always be in GBP.</p>
				<BtcAcceptedHere />
			</>
		)
	},
	...
	bodyContent: () => {
		...
		return (
			<>
				...
				<HorizontalList
					listItems={[cv, linkedIn, gitHub, thoughts]}
					heading="Other links:"
				/>
			</>
		)
