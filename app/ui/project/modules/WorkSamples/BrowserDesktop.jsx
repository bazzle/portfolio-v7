	...
	return (
		<div className={styles.browserDesktop}>
			<svg viewBox="0 0 400 280" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				>
					<path
						d="M6 31.94C6 30.3163 7.34315 29 9 29H391C392.657 29 394 30.3163 394 31.94V271.06C394 272.684 392.657 274 391 274H9.00001C7.34315 274 6 272.684 6 271.06V31.94Z"
						fill="white"
					/>
				</mask>
				<image
