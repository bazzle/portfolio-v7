	...
	return (
		<figure className={styleString}>
			...
			>
				...
				>
					<path
						d="M18 68.664C18 63.879 22.0364 60 27.0155 60H1174.98C1179.96 60 1184 63.879 1184 68.664V773.336C1184 778.121 1179.96 782 1174.98 782H27.0155C22.0364 782 18 778.121 18 773.336V68.664Z"
						fill="white"
					/>
				</mask>
			...
			{caption && (
				<figcaption className={styles.browserFrame__caption}>
					{caption}
				</figcaption>
			)}
		</figure>
	...
	return (
		<figure className={styleString}>
			...
			>
				...
				>
					<path
						d="M17.1426 82.8572C17.1426 78.1233 20.9801 74.2858 25.714 74.2858H380C384.734 74.2858 388.571 78.1233 388.571 82.8572V768.571C388.571 773.305 384.734 777.143 380 777.143H25.714C20.9801 777.143 17.1426 773.305 17.1426 768.571V82.8572Z"
						fill="white"
					/>
				</mask>
				<image
